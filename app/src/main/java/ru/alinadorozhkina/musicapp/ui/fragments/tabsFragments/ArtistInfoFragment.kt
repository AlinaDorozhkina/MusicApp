...
import kotlinx.android.synthetic.main.layout_main_player.view.button_play
import kotlinx.android.synthetic.main.layout_main_player.view.button_stop
...
class ArtistInfoFragment : MvpAppCompatFragment(), ArtistView {
    ...
    override fun init() {
        ui?.rvArtistTracks?.layoutManager = GridLayoutManager(requireContext(), 2)
    ...
    override fun playArtistTrack(track: ArtistTrack) {
        ...
        bottomSheetBehavior.addBottomSheetCallback(object :
            ...
            override fun onStateChanged(bottomSheet: View, newState: Int) {
                ...
                bottomSheet.ib_favourites.setOnClickListener {
...
//
//    override fun playArtistTrack(track: ArtistTrack) {
//        Log.v("ArtistInfoFragment", " зашли в метод playArtistTrack")
...
//                bottomSheet.ib_favourites.setOnClickListener {
//                    if (!full) {
//                        Log.v("ArtistInfoFragment", " нажата кнопка button favourites empty")
//                    } else {
//                        Log.v("ArtistInfoFragment", " нажата кнопка button favourites full ")
//                    }
//                }
//            }
//
